...
public class ABRandomUtils {
    ...
    public static String getRandom(String source, int length) {
        return ABStringUtils.isEmpty(source) ? null : getRandom(source.toCharArray(), length);
    }
