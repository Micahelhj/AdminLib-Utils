 ...
 * 修改备注：
 */
public class ABLogService extends Service {
    private static final String TAG = "ABLogService";
    ...
    private void init() {
        ...
        Log.i(TAG, "ABLogService onCreate");
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        recordLogServiceLog("ABLogService onDestroy");
        if (writer != null) {
            try {
                writer.close();
            } catch (IOException e) {
...
//Intent stateService =  new Intent (context,ABLogService.class);
//context.stopService(stateService);
//
//
//<service
//android:name="com.wondersgroup.qdyth.zsjc.services.ABLogService" >
//</service>