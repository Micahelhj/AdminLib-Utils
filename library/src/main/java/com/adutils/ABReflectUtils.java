...
/**
 * 项目名称：AdminLibs
 * 类描述：反射工具类，提供一些Java基本的反射功能
 * 创建时间：2016/2/4 14:45
 * 修改人：Michael
 * 修改时间：2016/2/4 14:45
 * 修改备注：
 */
public class ABReflectUtils {
    ...
    public static <T> T getObjectByFieldName(Object object, String fieldName, Class<T> clas) {
        if (object != null && ABStringUtils.isNotEmpty(fieldName) && clas != null) {
            try {
                Field field = ABReflectUtils.getField(object.getClass(), fieldName, true, true);
                if (field != null) {
                    field.setAccessible(true);
