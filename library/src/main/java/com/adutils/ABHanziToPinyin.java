...
public class ABHanziToPinyin {
    ...
    public static String getPinYin(String input) {
        ...
        ArrayList<Token> tokens = ABHanziToPinyin.getInstance().get(input);
    ...
    private static final String TAG = "ABHanziToPinyin";
    ...
    private static ABHanziToPinyin sInstance;
    ...
    protected ABHanziToPinyin(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }


    public static ABHanziToPinyin getInstance() {
        synchronized (ABHanziToPinyin.class) {
            if (sInstance != null) {
                return sInstance;
            }
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINA)) {
                    ...
                    sInstance = new ABHanziToPinyin(true);
                    return sInstance;
                }
            }
            Log.w(TAG,
                    "There is no Chinese collator, ABHanziToPinyin is disabled");
            sInstance = new ABHanziToPinyin(false);
            return sInstance;
        }
    }
