...
public class ABLoopTimer {
     ...
     */
    public ABLoopTimer(Handler handler, Runnable runnable, int intervalMillis) {
     ...
     * @param intervalMillis
     */
    public ABLoopTimer(Runnable runnable, int intervalMillis) {
