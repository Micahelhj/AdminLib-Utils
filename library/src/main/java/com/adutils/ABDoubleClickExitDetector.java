 ...
 * 双击退出识别器
 */
public class ABDoubleClickExitDetector {

    private static ABDoubleClickExitDetector abDoubleClick = null;
     ...
     */
    public ABDoubleClickExitDetector(Context context, String hintMessage, int effectiveIntervalTime) {
     ...
     */
    public ABDoubleClickExitDetector(Context context, String hintContent) {
     ...
     * @param context 上下文
     */
    public ABDoubleClickExitDetector(Context context) {
     ...
     *
     * @param c 上下文
     * @return ABDoubleClickExitDetector实例化对象
     */
    public static ABDoubleClickExitDetector getInstance(Context c) {
        if (abDoubleClick == null)
            abDoubleClick = new ABDoubleClickExitDetector(c);
        return abDoubleClick;
    }
     ...
     * @return ABDoubleClickExitDetector实例化对象
     */
    public static ABDoubleClickExitDetector getInstance(Context context, String hintContent) {
        if (abDoubleClick == null)
            abDoubleClick = new ABDoubleClickExitDetector(context, hintContent, 2000);
        return abDoubleClick;
    }
     ...
     * @return ABDoubleClickExitDetector实例化对象
     */
    public static ABDoubleClickExitDetector getInstance(Context context, String hintMessage, int effectiveIntervalTime) {
        if (abDoubleClick == null)
            abDoubleClick = new ABDoubleClickExitDetector(context, hintMessage, effectiveIntervalTime);
        return abDoubleClick;
    }
