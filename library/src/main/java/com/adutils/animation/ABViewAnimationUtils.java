 ...
 */
public final class ABViewAnimationUtils {

    /**
     * Don't let anyone instantiate this class.
     */
    private ABViewAnimationUtils() {
    ...
    public static void invisibleViewByAlpha(final View view,
        ...
        if (view.getVisibility() != View.INVISIBLE) {
            ...
            AlphaAnimation hiddenAlphaAnimation = ABAnimationUtils
    ...
    public static void invisibleViewByAlpha(final View view,
        ...
        invisibleViewByAlpha(view, ABAnimationUtils.DEFAULT_ANIMATION_DURATION,
    ...
    public static void goneViewByAlpha(final View view,
                                       final boolean isBanClick, final AnimationListener animationListener) {
        goneViewByAlpha(view, ABAnimationUtils.DEFAULT_ANIMATION_DURATION,
                isBanClick, animationListener);
    }
    ...
    public static void goneViewByAlpha(final View view,
                                       final AnimationListener animationListener) {
        goneViewByAlpha(view, ABAnimationUtils.DEFAULT_ANIMATION_DURATION, false,
                animationListener);
    }
    ...
    public static void visibleViewByAlpha(final View view, long durationMillis,
        ...
        if (view.getVisibility() != View.VISIBLE) {
            ...
            AlphaAnimation showAlphaAnimation = ABAnimationUtils
    ...
    public static void visibleViewByAlpha(final View view,
                                          final boolean isBanClick, final AnimationListener animationListener) {
        visibleViewByAlpha(view, ABAnimationUtils.DEFAULT_ANIMATION_DURATION,
                isBanClick, animationListener);
    }
