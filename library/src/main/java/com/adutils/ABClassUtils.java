...
/**
 * ABClassUtils. (Tool, Static, ThreadSafe)
 *
 */
public class ABClassUtils {
    ...
    private static Class<?> _forName(String name)
        ...
        if (ABStringUtils.isEmpty(name)) return null;
        String key = name;
    ...
    public static boolean isBeforeJava5(String javaVersion) {
        return (ABStringUtils.isEmpty(javaVersion) || "1.0".equals(javaVersion) ||
                    ...
                    if (parameterTypes.length > 0) {
                        ...
                        for (int i = 0; i < parameterTypes.length; i++) {
                            ...
                            if (type != null && parameterType != null &&
                                ...
                                eq = false;
                                if (boxed) {
                                    type = ABClassUtils.getBoxedClass(type);
                                    parameterType = ABClassUtils.getBoxedClass(
                                            parameterType);
                                }
    ...
    public static boolean toBoolean(String value) {
        return ABStringUtils.isEmpty(value) ? false : Boolean.parseBoolean(value);
    }


    public static char toChar(String value) {
        return ABStringUtils.isEmpty(value) ? '\0' : value.charAt(0);
    }


    public static byte toByte(String value) {
        return ABStringUtils.isEmpty(value) ? 0 : Byte.parseByte(value);
    }


    public static short toShort(String value) {
        return ABStringUtils.isEmpty(value) ? 0 : Short.parseShort(value);
    }


    public static int toInt(String value) {
        return ABStringUtils.isEmpty(value) ? 0 : Integer.parseInt(value);
    }


    public static long toLong(String value) {
        return ABStringUtils.isEmpty(value) ? 0 : Long.parseLong(value);
    }


    public static float toFloat(String value) {
        return ABStringUtils.isEmpty(value) ? 0 : Float.parseFloat(value);
    }


    public static double toDouble(String value) {
        return ABStringUtils.isEmpty(value) ? 0 : Double.parseDouble(value);
    }


    public static Class<?> toClass(String value) {
        return ABStringUtils.isEmpty(value) ? null : ABClassUtils.forName(value);
    }
    ...
    public static Object getProperty(Object bean, String property) {
        if (bean == null || ABStringUtils.isEmpty(property)) {
            return null;
        }
        try {
    ...
    public static Object convertCompatibleType(Object value, Class<?> type) {
        ...
        if (value instanceof String) {
            ...
            if (char.class.equals(type) || Character.class.equals(type)) {
                ...
                return ABClassUtils.forName((String) value);
            }
        }
