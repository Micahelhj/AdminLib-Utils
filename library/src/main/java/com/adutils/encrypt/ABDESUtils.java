...
public class ABDESUtils {
     ...
     * 算法
     */
    private static final String ALGORITHM = "ABDESUtils";
    /**
     * IV
     */
     ...
     * TRANSFORMATION
     */
    private static final String TRANSFORMATION = "ABDESUtils/CBC/PKCS5Padding";
    ...
    public String encrypt(String source) {
        ...
        try {
            ...
            if (code == 0) {
                ...
                result = ABBase64.encodeToString(retByte, false);
            } else {
    ...
    public String decrypt(String encrypted) {
        ...
        try {
            ...
            if (code == 0) {
                ...
                retByte = ABBase64.decode(encrypted);
            } else {
